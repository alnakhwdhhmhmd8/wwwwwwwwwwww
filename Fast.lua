...
function Dev(msg) 
ok = false
local list = {Sudo_Id,1405636280,5490392130,7280622775}
...
return send(msg.chat_id,msg.id,"☭ الوضع المجاني معطل الان  💎 .\n☭ راسل المطور لتنصيب مدفوع  💎 . \n☭ Dev : @wwvvwt  💎 .")
end
if text == "/start" then
...
keyboard.inline_keyboard = {
{
{text = '❪ ժᥱ᥎ ᥉᥆υᖇᥴᥱ ❫', url = "https://t.me/wwvvwt"}
},
{  
{text = '❪ 𝒔𝒐𝒖𝒓𝒄𝒆 ᴊᴀᴋ❫', url = 't.me/xvwwvl '},
},
...
photo = "https://envs.sh/zjH.jpg"
local T =[[
 [ꪝ꧖ᥣᥴ᥆᧗꧖ ﾋ᥆ ᥉᥆ᖇᥴ꧖ ꫝ᥆ᖇ᥉꧖](t.me/xvwwvl)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '❪ ძᥱ᥎ ᥉᥆υᖇᥴᥱ ❫', url = 't.me/wwvvwt'},
},
{  
{text = '❪ 𝒔𝒐𝒖𝒓𝒄𝒆 ᴊᴀᴋ❫', url = 't.me/xvwwvl'},
},
...
if text == '☭ مبرمج السورس' or text == 'جاك' then
photo = "https://files.catbox.moe/uv47pv.jpg"
local T =[[
 [ ᯓ 𓆩 ˹ †ø δølløω ძενεløρεƦ øδ †hε ՏøuƦcε ˼ 𓆪 𓆃 ](t.me/wwvvwt)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '❪ ժᥱ᥎ ᖴᖇ3᥆ꪀ ❫', url = 't.me/wwvvwt'},
},
{  
{text = '❪ 𝒔𝒐𝒖𝒓𝒄𝒆 ᴊᴀᴋ❫', url = 't.me/xvwwvl '},
},
